					...
					<el-tabs>
				      	<el-tab-pane label="点餐">
				      		<el-table :data="tableData" border style="width: 100%;">
				      		    ...
				      		    <el-table-column prop="count" 	  label="数量" width="70" header-align="center" align="center"></el-table-column>
				      		    <el-table-column prop="price" 	  label="单价" width="70" header-align="center" align="center"></el-table-column>
